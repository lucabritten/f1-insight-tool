...
import htwsaar.nordpol.service.report.ProgressListener;
...
class SessionReportServiceTest {
    ...
    private final ProgressListener noOpProgress = message -> {};
    ...
    class Validation {
        ...
        @Test
        void throwsException_whenTopDriversIsZero() {
            assertThatThrownBy(() -> sessionReportService.buildReport(LOCATION, YEAR, SessionName.RACE, 0, noOpProgress))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessage("topDrivers must be greater than zero.");
        }

        @Test
        void throwsException_whenTopDriversIsNegative() {
            assertThatThrownBy(() -> sessionReportService.buildReport(LOCATION, YEAR, SessionName.RACE, -1, noOpProgress))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessage("topDrivers must be greater than zero.");
        }
    }
    ...
    class BuildReport {
        ...
        @Test
        void returnsCompleteReport_withAllData() {
            ...
            SessionReport report = sessionReportService.buildReport(LOCATION, YEAR, SessionName.RACE, null, noOpProgress);
        ...
        void filtersResults_toTopNDrivers() {
            ...
            SessionReport report = sessionReportService.buildReport(LOCATION, YEAR, SessionName.RACE, 1, noOpProgress);
        ...
        void preloadsDrivers_forMeetingBeforeResolving() {
            ...
            sessionReportService.buildReport(LOCATION, YEAR, SessionName.RACE, null, noOpProgress);
        ...
        @Test
        void buildsReportForQualifyingSession() {
            ...
            SessionReport report = sessionReportService.buildReport(LOCATION, YEAR, SessionName.QUALIFYING, null, noOpProgress);
        ...
        @Test
        void buildsReportForPracticeSession() {
            ...
            SessionReport report = sessionReportService.buildReport(LOCATION, YEAR, SessionName.PRACTICE1, null, noOpProgress);
    ...
    class ErrorHandling {
        ...
        @Test
        void propagatesException_whenWeatherServiceFails() {
            when(meetingService.getMeetingByYearAndLocation(YEAR, LOCATION)).thenReturn(defaultMeeting);
            ...
            assertThatThrownBy(() -> sessionReportService.buildReport(LOCATION, YEAR, SessionName.RACE, null, noOpProgress))
                    .isInstanceOf(RuntimeException.class)
                    .hasMessage("Weather service unavailable");
        }

        @Test
        void propagatesException_whenSessionResultServiceFails() {
            when(meetingService.getMeetingByYearAndLocation(YEAR, LOCATION)).thenReturn(defaultMeeting);
            when(sessionService.getSessionByMeetingKeyAndSessionName(MEETING_KEY, SessionName.RACE))
                    .thenReturn(defaultSession);
            when(weatherService.getWeatherByLocationYearAndSessionName(LOCATION, YEAR, SessionName.RACE))
